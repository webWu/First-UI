<!--本文件由FirstUI授权予江苏络思物联科技有限公司（手机号：13 6 21 5 1 71   9  9，身份证尾号：KYGW4C）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view :class="{'fui-input__border':inputBorder,'fui-radius__fillet':isFillet}" :style="getStyles" @tap="fieldClick">
		<view class="fui-input__wrap" :class="{'fui-radius__fillet':isFillet,'fui-input__border-radius':inputBorder && !isFillet}"
			...
			<input class="fui-input__self" :class="{'fui-input__text-right':textRight}"
				...
				:enableNative="false" :always-embed="alwaysEmbed" @focus="onFocus" @blur="onBlur" @input="onInput" @confirm="onConfirm"
