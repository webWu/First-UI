<!--本文件由FirstUI授权予江苏络思物联科技有限公司（手机号：1 3 62   1 517  1 9 9，身份证尾号：KYGW4C）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-license__plate-wrap"
		:class="{'fui-license__plate__ani':show,'fui-lp__theme-light':theme==='light','fui-lp__theme-dark':theme==='dark','fui-lp__safe-weex':iphoneX}"
