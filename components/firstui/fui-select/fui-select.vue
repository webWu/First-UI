<!--本文件由FirstUI授权予江苏络思物联科技有限公司（手机号： 136215  1 7  1  9  9，身份证尾号：KYGW4C）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view v-if="isShow || !isNvue" @touchmove.stop.prevent="stop">
		...
		<view class="fui-select__wrap" ref="fui_select_ani"
			:class="{'fui-select__wrap-show':show,'fui-select__weex-android':isAndroid,'fui-select__safe-weex':iphoneX}"
