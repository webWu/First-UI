<!--本文件由FirstUI授权予江苏络思物联科技有限公司（手机号：   1  36215  1  719 9，身份证尾号：KYGW4C）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view @touchend="stop">
		<view class="fui-share__sheet-mask" :style="getStyle" :class="{'fui-ss__mask-show':show}" ref="fui_ssm_ani"
			@tap.stop="maskClick">
		</view>
		<view class="fui-share__sheet-wrap" :class="{'fui-share__sheet-radius':radius,'fui-share__sheet-show':show}"
			...
			<view class="fui-share__sheet-button" :class="{'fui-ss__safe-weex':iphoneX }"
				:style="{background:btnBackground}">
				<text class="fui-share__sheet-btn" :class="{'fui-ss__safe-weex':iphoneX}"
