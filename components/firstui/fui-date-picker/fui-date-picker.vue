<!--本文件由FirstUI授权予江苏络思物联科技有限公司（手机号：13   6   2 1 517 1 99，身份证尾号：KYGW4C）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
...
<style scoped>
	...
	/* #ifndef APP-NVUE*/
	/deep/.fui-date__picker-indicator {
		position: relative;
		border-color: transparent;
	}

	/deep/.fui-date__picker-indicator::before {
		border-color: #333;
	}

	/deep/.fui-date__picker-indicator::after {
		border-color: #333;
	}
